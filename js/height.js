...
contentDiv = jQuery("#stt_content");
contentMarginDiv = jQuery("#stt_content_margin");
sidebar1Div = jQuery("#stt_sidebar_left");
sidebar2Div = jQuery("#stt_sidebar_right");
sidebar1MarginDiv = jQuery("#stt_sidebar_left_margin");
sidebar2MarginDiv = jQuery("#stt_sidebar_right_margin");
if (sidebar1Div != null)
{
